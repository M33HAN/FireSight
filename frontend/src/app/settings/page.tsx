...
const CATEGORY_ICONS: Record<string, string> = {
    human: "👤", vehicle: "🚗", fire: "🔥", smoke: "💨", bicycle: "🚲",
    plant: "🏗️", ppe: "🦺", accident: "💥", intrusion: "🚨", fall: "⬇️",
};
...
export default function SettingsPage() {
  ...
  return (
        <div className="space-y-6">
          {/* Page Header */}
              <div>
                      <h1 className="text-2xl font-bold tracking-tight">Settings</h1>h1>
                      <p className="text-gray-500 mt-1 text-sm">Configure FireSight platform preferences</p>p>
              </div>div>
          ...
          {/* Tab Navigation */}
              ...
              <div className="max-w-3xl">
                ...
                {activeTab === "detection" && (
                    <div className="space-y-4">
                                <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl border border-white/5 p-6">
                                              <h3 className="text-sm font-semibold text-gray-300 mb-4">Confidence Threshold</h3>h3>
                                              <ConfidenceTuner
                                ...
                                <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl border border-white/5 p-6">
                                              <h3 className="text-sm font-semibold text-gray-300 mb-4">Detection Categories</h3>h3>
                                        ...
                                        <label
                                                            ...
                                                            <input
                                                                                    ...
                                                                                    className="sr-only"
                                                                                  />
                                                            <span className="text-base">{CATEGORY_ICONS[cat]}</span>span>
                                                            <span className="text-sm capitalize">{cat}</span>span>
                                        </label>label>
                                      ))}
                                              </div>div>
                                </div>div>
                                ...
                                <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl border border-white/5 p-6">
                                              <h3 className="text-sm font-semibold text-gray-300 mb-4">Model Variant</h3>h3>
                                              <select
                                                              ...
                                                              >
                                                              <option value="yolov8n">YOLOv8 Nano (Fastest)</option>option>
                                                              <option value="yolov8s">YOLOv8 Small</option>option>
                                                              <option value="yolov8m">YOLOv8 Medium</option>option>
                                                              <option value="yolov8l">YOLOv8 Large</option>option>
                                                              <option value="yolov11n">YOLOv11 Nano</option>option>
                                                              <option value="yolov11s">YOLOv11 Small</option>option>
                                              </select>select>
                                </div>div>
                    </div>div>
                      )}
                ...
                {activeTab === "alerts" && (
                    <div className="space-y-4">
                                <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl border border-white/5 p-6">
                                              <h3 className="text-sm font-semibold text-gray-300 mb-4">Notification Channels</h3>h3>
                      ...
                      { key: "webhook_enabled", label: "Custom Webhook", desc: "POST alerts to a custom URL" },
                                                          ...
                                                          <label
                                                                              ...
                                                                              >
                                                                              <div>
                                                                                                    <span className="text-sm font-medium text-gray-300">{label}</span>span>
                                                                                                    <p className="text-xs text-gray-600 mt-0.5">{desc}</p>p>
                                                                              </div>div>
                ...
                {activeTab === "storage" && (
                    <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl border border-white/5 p-6 space-y-5">
                                <h3 className="text-sm font-semibold text-gray-300 mb-2">Storage Configuration</h3>h3>
                      {[
                                                  ...
                                                  <div key={key}>
                                                                  ...
                                                                  <input
                                                                                      ...
                                                                                      onChange={(e) =>
                                                                                                            setSettings({
                                                                                                                                    ...settings,
                                                                                                                                    storage: { ...settings.storage, [key]: Number(e.target.value) },
                                                                                                              })
                                                                                        }
                ...
                {activeTab === "general" && (
                    <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl border border-white/5 p-6 space-y-5">
                                <h3 className="text-sm font-semibold text-gray-300 mb-2">General</h3>h3>
                                <div>
                                              <label className="block text-sm text-gray-400 mb-1.5">Site Name</label>label>
                                              <input
                                                                type="text"
                                ...
                                <div>
                                              <label className="block text-sm text-gray-400 mb-1.5">Timezone</label>label>
                                              <select
                                                              ...
                                                              >
                                                              <option value="Europe/London">Europe/London (GMT)</option>option>
                                                              <option value="America/New_York">America/New_York (EST)</option>option>
                                                              <option value="America/Los_Angeles">America/Los_Angeles (PST)</option>option>
                                                              <option value="Asia/Tokyo">Asia/Tokyo (JST)</option>option>
                                                              <option value="UTC">UTC</option>option>
                                              </select>select>
                                </div>div>
                    </div>div>
                      )}
